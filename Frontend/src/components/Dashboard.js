...
const Dashboard = () => {
  ...
  const totalAvailable = accounts.reduce(
    (sum, acc) =>
      sum + parseFloat(acc.available_balance || 0),
    0
  );
      ...
      <div className="stat-grid">
        ...
        <div className="stat-card">
          ...
          <div className="stat-info">
            ...
            <h3>
              {formatIndianAmount(totalAvailable)}
            </h3>
